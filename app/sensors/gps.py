...
i2c_bus = smbus2.SMBus(5)  # Utilitza el bus I2C configurat

# Inicialitza el compàs
# Mode: Continuous, Output Data Rate: 10Hz, Full Scale: 2G, Over Sample Ratio: 512
i2c_bus.write_byte_data(I2C_ADDR, 0x0B, 0x01)  # Reset
i2c_bus.write_byte_data(I2C_ADDR, 0x09, 0b00011101)

def parse_coord(coord, direction):
...
def read_heading():
    ...
    data = i2c_bus.read_i2c_block_data(I2C_ADDR, 0x00, 6)
    x = data[1] << 8 | data[0]
    y = data[3] << 8 | data[2]
